...
if __name__ == '__main__':
    parse_names = [{'ticker': 'SFIN', 'parse_name': 'Сафмар, Safmar'}, {'ticker': 'FIVE', 'parse_name': 'X5'},
                   ...
                   {'ticker': 'SBER', 'parse_name': 'Сбербанк'}, {'ticker': 'SBERP', 'parse_name': 'Сбербанк'},
                   {'ticker': 'CHMF', 'parse_name': 'Северсталь'}, {'ticker': 'AFKS', 'parse_name': 'АФК Система'},
                   {'ticker': 'SNGS', 'parse_name': 'Сургутнефтегаз'},
                   {'ticker': 'SNGSP', 'parse_name': 'Сургутнефтегаз'}, {'ticker': 'TATN', 'parse_name': 'Татнефть'},
                   {'ticker': 'TATNP', 'parse_name': 'Татнефть'}, {'ticker': 'TRMK', 'parse_name': 'ТМК'},
