...
def calculate_linreg_coef_and_pvalues():
    tickers = [{'name': 'Safmar Fin', 'ticker': 'SFIN', 'parse_name': 'Сафмар, Safmar'},
               ...
               {'name': 'Сбербанк (прив.)', 'ticker': 'SBERP', 'parse_name': 'Сбербанк'},
               ...
               {'name': 'Сургутнефтегаз (прив.)', 'ticker': 'SNGSP', 'parse_name': 'Сургутнефтегаз'},
               {'name': 'Татнефть', 'ticker': 'TATN', 'parse_name': 'Татнефть'},
               {'name': 'Татнефть (прив.)', 'ticker': 'TATNP', 'parse_name': 'Татнефть'},
               {'name': 'ТМК ОАО ', 'ticker': 'TRMK', 'parse_name': 'ТМК'},
               {'name': 'Транснефть (прив.)', 'ticker': 'TRNFP', 'parse_name': 'Транснефть'},
